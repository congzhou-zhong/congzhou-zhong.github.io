...
document.write('<script src="' + bootPATH + 'layui/layui.all.js" type="text/javascript"></sc' + 'ript>');
...
document.write('<script src="' + bootPATH + '../ajaxIntercept.js" type="text/javascript" ></sc' + 'ript>');
document.write('<script src="' + bootPATH + '../common.js" type="text/javascript" ></sc' + 'ript>');

document.write('<script src="' + bootPATH + '../crypto-js.js" type="text/javascript" ></sc' + 'ript>');

document.write('<script src="' + bootPATH + '../cryptoMethodInst.js" type="text/javascript" ></sc' + 'ript>');
document.write('<script src="' + bootPATH + '../cryptoMethod.js" type="text/javascript" ></sc' + 'ript>');
// NUI 3.5.0 new skin
document.write('<link href="' + bootPATH + 'themes/bootstarp/skin.css" rel="stylesheet" type="text/css" />');

document.write('<link href="' + bootPATH + 'layui/layui.css" rel="stylesheet" type="text/css" />');
//skin
